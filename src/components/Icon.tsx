...
const P: Record<string, string> = {
  ...
  /* The mic, struck through — the off state of the demo voice. */
  mute: 'M12 3a3 3 0 0 1 3 3v5M9 7v5a3 3 0 0 0 4.6 2.5M5 11a7 7 0 0 0 10.6 6M19 11v1M12 18v3M4 3l16 18',
